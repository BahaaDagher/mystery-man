...
const Report = () => {
  const getBranchesData = useSelector(
    (state) => state.branchData.getBranchesData
  );
      ...
      <Parent>
        ...
        <BarParent>
          ...
          >
            ...
            <Bar
              dataKey={showRate ? "rate" : "missions"}
              fill={Colors.main}
              background={{ fill: Colors.lightMain }}
              rx={8}
            />
