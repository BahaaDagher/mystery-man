...
const OneBranchReport = ({oneBranchData}) => {
  return (
    <div className='flex flex-col gap-3'>
      ...
      <div className='w-full bg-white rounded-[12px] p-6 '><DepartmentDevelopmentRate apiData={oneBranchData.stepProgressOverTime}/></div>
    </div>
  )
}
